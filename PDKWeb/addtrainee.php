<?php 
    ...
    { 
        ...
        $result = insert_trainee($trainee);


        $lastid=mysqli_insert_id($db);

        $tpp['tr-id'] = $lastid;
        $tpp['tpp-name']= $_POST['tpp-name'];
        $tpp['tpp-ic']= $_POST['tpp-ic'];
        $tpp['tpp-relation']= $_POST['tpp-relation']; 
        $tpp['tpp-gender']= $_POST['trainee-gender']; 
        $tpp['tpp-phone']= $_POST['tpp-phone']; 
        $tpp['tpp-occupation']= $_POST['tpp-occupation']; 
        $tpp['tpp-salary']= $_POST['tpp-salary']; 

        $ta['tr-id'] = $lastid;
        $ta['ta-category']=$_POST['ta-category'];
        $ta['ta-okulevel']=$_POST['ta-okulevel'];
        $ta['ta-disease']=$_POST['ta-disease'];
        $ta['ta-attitude']=$_POST['ta-attitude'];
        $ta['ta-mobility']=$_POST['ta-mobility'];
        
        
        $taa['tr-id'] = $lastid;
        $taa['taa-schstatus']=$_POST['taa-schstatus'];
        $taa['taa-schname']=$_POST['taa-schname'];
        $taa['taa-schclass']=$_POST['taa-schclass'];
        $taa['taa-schyear']=$_POST['taa-schyear'];


         if($result === true)
         {
             
            $result2= insert_tpp($tpp);
            $result3= insert_ta($ta);
            $result4= insert_taa($taa);
...
<body id="page-top">
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="addtrainee.php"><i class="fas fa-user"></i><span style="margin-left: 5px;">Add Trainee</span></a></li>
    ...
    <h3 style="text-align: center">New Trainee entry</h3><p><p>
    <div class="row mb-3">
    <div class="col-lg-2">
    </div>
    <div class="col-lg-8">
    ...
    <div class="card-body">
    <form method="post" action="addtrainee.php">
    <div class="row">
    <div class="col">
    ...
    <div class="row">
    <div class="col">
    <div class="mb-3"><label class="form-label" for="address"><strong>Guardian Salary</strong></label><input class="form-control" type="text" id="tpp-salary"  name="tpp-salary"></div></div>
    ...
    <div class="card shadow mb-3">
    <div class="card-header py-3">
    <p class="text-primary m-0 fw-bold">Trainee Ability Information</p>
    </div>
    <div class="card-body">
    <div class="row">
    <div class="col">
    ...
    <div class="row">
    <div class="col">
    <div class="mb-3"><label class="form-label" for="username"><strong>OKU Category</strong><br></label><input class="form-control" type="text" id="ta-category" name="ta-category"></div>
    <div class="row">
    <div class="col">
    <div class="mb-3"><label class="form-label" for="address"><strong>OKU Level</strong></label><input class="form-control" type="text" id="ta-okulevel"  name="ta-okulevel"></div>
    <div class="row">
    <div class="col">
    <div class="mb-3"><label class="form-label" for="address"><strong>Disease</strong></label><input class="form-control" type="text" id="ta-disease"  name="ta-disease"></div>
    <div class="row">
    <div class="col">
    <div class="mb-3"><label class="form-label" for="address"><strong>Attitude</strong></label><input class="form-control" type="text" id="ta-attitude"  name="ta-attitude"></div>
    <div class="row">
    <div class="col">
    <div class="mb-3"><label class="form-label" for="address"><strong>Mobility</strong></label><input class="form-control" type="text" id="ta-mobility"  name="ta-mobility"></div>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="card shadow mb-3">
    <div class="card-header py-3">
    <p class="text-primary m-0 fw-bold">Trainee Additional Information</p>
    </div>
    <div class="card-body">
    <div class="row">
    <div class="col">
    <div class="row">
    <div class="col">
    <div class="mb-3"><label class="form-label" for="username"><strong>School Status</strong><br></label><input class="form-control" type="text" id="taa-schstatus" name="taa-schstatus"></div>
    <div class="row">
    <div class="col">
    <div class="mb-3"><label class="form-label" for="address"><strong>School Name</strong></label><input class="form-control" type="text" id="taa-schname"  name="taa-schname"></div>
    <div class="row">
    <div class="col">
    <div class="mb-3"><label class="form-label" for="address"><strong>Class</strong></label><input class="form-control" type="text" id="taa-schclass"  name="taa-schclass"></div>
    <div class="row">
    <div class="col">
    <div class="mb-3"><label class="form-label" for="address"><strong>Year</strong></label><input class="form-control" type="text" id="taa-schyear"  name="taa-schyear"></div>
    </div>
    </div>
    </div>
    </div>
